...
jdbc:relique:csv:/home/wang/MEGA/MEGAsync/项目/南药/南药智能补货POC数据

org.relique.jdbc.csv.CsvDriver

jdbc:relique:csv:{folder}
...
mail_user = "etl@linezonedata.com"
mail_pass = "密码"
receivers = "wangchangzhen@linezonedata.com"
